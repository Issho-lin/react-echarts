...
class App extends Component {
  ...
  convertData(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      console.log(this.state.geoCoordMap)
  ...
  componentDidMount() {
    ...
    let mySunburst = echarts.init(document.getElementById('sunburst'));
    // 旭日图配置
    mySunburst.setOption({
      title: {
    ...
    let myGeoCoordMap = echarts.init(document.getElementById('geoCoordMap'));
    myGeoCoordMap.setOption({
      title: {
